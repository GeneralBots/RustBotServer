...
lxc config device add "$PARAM_TENANT"-doc-editor doceditordata disk source="$HOST_DATA" path=/opt/gbo/data
lxc config device add "$PARAM_TENANT"-doc-editor doceditorconf disk source="$HOST_CONF" path=/opt/gbo/conf
lxc config device add "$PARAM_TENANT"-doc-editor doceditorlogs disk source="$HOST_LOGS" path=/opt/gbo/logs
